...
\setDocAbstract{%
This document describes the data products and processing services to be delivered by Rubin Observatory's Legacy Survey of Space and Time (LSST).
%
...
The \textbf{Rubin Science Platform}, \citeds{LSE-319}, will allow for the creation of  \textbf{User Generated} data products and will enable science cases that greatly benefit from co-location of user processing and/or data within the Rubin Data Access Centers (DAC).
Rubin will also devote 10\% of observing time to programs with special cadence.
Data products from these special programs will be created using the same software and hardware as Prompt and Data Release data products.
...
The purpose of this document is to describe the data products produced by Rubin Observatory's Legacy Survey of Space and Time (LSST).

To a future Rubin/LSST user, it should clarify what data products, software and services they can expect. 
To Rubin/LSST builders, it provides direction on how to flow down the Rubin LSST System Requirements (LSR), \citeds{LSE-29},  to Data Management system design, sizing, budget and schedule as they pertain to the data products.

Though under strict change control, this is a \textbf{\emph{living document}}. 


%LSST will undergo a period of construction  and commissioning lasting no less than seven years, followed by a decade of survey operations. To ensure their continued scientific adequacy, the designs and plans for LSST Data Products will be periodically reviewed and updated.

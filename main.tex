...
\begin{itemize}
    ...
    \item {\em Should we, and can we (within budget), provide forced photometry of detected \DIASources on individual snaps (or the difference of snaps)}? We'd need to document scientific use cases that demand this, as well as assessment that it's technically feasible.

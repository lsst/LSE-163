...
% The majority of \Objects in the \Object table, derived by associating the sources in individual epochs and deep coadds, will be below the single-visit signal-to-noise detection threshold.

...
\item If the \DIASource has been associated with an \SSObject (a known moving object), it will be flagged as such and a \VOEvent issued. Further processing will occur in daytime (see section \ref{sec:ssProcessing}).

...
LSST does {\em not} plan to build or deploy algorithms specifically optimized for crowded field photometry. {\em \bf Processing these areas with advanced crowded field photometry codes is left to the users as a Level 3 task.}
...
\subsubsection{Migration of Level 3 data products to Level 2}

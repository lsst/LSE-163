...
%We will provide estimates of the relative and absolute photometric calibration errors, and the
%normalized system response (for details see Section 3.3.4 in the LSST Science Requirements Document). 
...
%Similarly, we will provide columns with flux expressed in Jy 
%(and its error estimate that includes the relative and absolute calibration error contributions).

...
M.~Gelman, R.~Gill, M.~Graham, \v{Z}.~Ivezi\'c, T.~Jenness,  J.~Kantor, K.S.~Krughoff,
...
\addtohist{3.3}{2018-02-28}{Implemented adoption of nano-jansky flux unit, added point estimates for photo-z, and a few minor edits.}{\v{Z}.~Ivezi\'{c}}
}
...
apFlux & float & nJy\footnote{LSST fluxes are reported in nano-jansky (1 nJy = $10^{−35}$ Wm$^{−2}$Hz$^{−1}$). 

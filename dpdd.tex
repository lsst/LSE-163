...
LSST fluxes are quoted in units of nano-jansky\footnote{For details, please see LSST Document-27758.} (1 nJy = $10^{−35}$ Wm$^{−2}$Hz$^{−1}$). We will provide estimates of the relative and absolute photometric calibration errors, and the 

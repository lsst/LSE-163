...
\item The collection of tracklets collected over the past 30 days\footnote{The exact time period is a design and computational question discussed in \lsstdoc{LDM-156}.} is searched for subsets forming \emph{tracks} consistent with being on the same Keplerian orbit around the Sun.
...
The tables themselves are defined in \lsstdoc{LDM-153}\footnote{The SQL definition itself can be found in the \texttt{cat} package.}.
...
In course of Level 2 processing, multiple classes and numerous of coadds will be created\footnote{See \lsstdoc{LDM-151} for more details.}:
